		...
		<div class="container">
			<div class="content">
				...
				<div class="carousel slide carousel-v2 margin-bottom-40" id="portfolio-carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<div class="dd-img-responsive1">
								<img class="full-width" src="<%=basePath%>static/image/upload/main1.png" alt="">
							</div>
						</div>
						<div class="item">
							
							<div class="dd-img-responsive1">
								<img class="full-width" src="<%=basePath%>static/image/upload/main2.png" alt="">
							</div>
						</div>
						<div class="item">
							
							<div class="dd-img-responsive1">
								<img class="full-width" src="<%=basePath%>static/image/upload/main3.png" alt="">
							</div>
						</div>
					</div>
				...
				<div class="row margin-bottom-60">
					<div class="col-sm-8">
						<div class="headline"><h2>产品描述</h2></div>
					...
					<div class="col-sm-4">
						<div class="headline"><h2>产品信息</h2></div>
						<ul class="list-unstyled project-details">
							<li><strong>Inventory:</strong>8888</li>
							<li><strong>Date:</strong> 17 October 2015</li>
							<li><strong>Categories:</strong> <a href="#">Web Design,</a> <a href="#">Graphic</a></li>
							<li><strong>Website:</strong> <a href="#">http://www.taobao.com/product</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="owl-carousel-v1 owl-work-v1 margin-bottom-40">
					<div class="headline"><h2 class="pull-left">最新款式</h2>
					...
					<div class="owl-recent-works-v1">
						...
						<div class="item">
							<a href="#">
								<em class="overflow-hidden">
									<div class="dd-img-responsive1">
										<img class="full-width" src="<%=basePath%>static/image/upload/main4.png" alt="">
									</div>
								</em>
								<span>
									<strong>Creative</strong>
									<i>Responsive Bootstrap</i>
								</span>
							</a>
						</div>
						<div class="item">
