...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../static/vendors/normalize/normalize.css"/>
    <%--<link rel="stylesheet" type="text/css" href="http://127.0.0.1:3000/dd.css"/>--%>
    <link rel="stylesheet" type="text/css" href="../../static/js/dist/dd.css"/>
...
<!-- <script src="static/project/love/core/config.js"></script>  -->
<script src="../../static/pages/core/admin/base/config.js"></script>

<script src="../../static/js/dist/common.js"></script>
<script src="../../static/js/dist/dd.js"></script>

<%--<script src="http://127.0.0.1:3000/common.js"></script>--%>
<%--<script src="http://127.0.0.1:3000/dd.js"></script>--%>


<%--<script src="../../static/vendors/JSXTransformer.js"></script>--%>
<script src="../../static/vendors/browser-es3.min.js"></script>

<!--路由文件-->
<script src="../../static/pages/core/admin/base/router.js"></script>
